...
.logo-text { color: #fff; font-weight: 800; font-size: var(--font-size-base, 14px); letter-spacing: 1px; }
...
.dash-role { font-size: var(--font-size-base, 12px); }

.sidebar-nav { flex: 1; }
.nav-item { padding: 12px 24px; font-size: var(--font-size-base, 13px); font-weight: 500; display: flex; align-items: center; }
...
.sidebar-contact { padding: 0 24px; font-size: var(--font-size-base, 12px); }
...
.kpi-title { font-size: var(--font-size-base, 12px); color: #64748b; font-weight: 600; text-transform: uppercase; margin-bottom: 8px; }
.kpi-value { font-size: var(--font-size-title, 28px); font-weight: 700; color: #0f172a; }
.kpi-unit { font-size: var(--font-size-base, 13px); color: #94a3b8; font-weight: 500; }
...
.panel-header { padding: 16px 20px; border-bottom: 1px solid #e2e8f0; font-size: var(--font-size-title, 14px); font-weight: 600; color: #0f172a; background: #f8fafc; }
.panel-body { padding: 20px; }
.p-0 { padding: 0; }

.dash-text { font-size: var(--font-size-base, 13px); color: #334155; line-height: 1.6; margin: 0; }

.dash-two-col { display: grid; grid-template-columns: 1.5fr 1fr; gap: 24px; }

/* Table */
.dash-table { width: 100%; border-collapse: collapse; font-size: var(--font-size-base, 13px); text-align: left; }
...
.td-date { color: #64748b; font-size: var(--font-size-base, 11px); text-align: center; white-space: nowrap; }

/* Skills */
.skill-bar-wrapper { margin-bottom: 16px; }
.skill-bar-wrapper:last-child { margin-bottom: 0; }
.sb-head { display: flex; justify-content: space-between; margin-bottom: 6px; font-size: var(--font-size-base, 12px); font-weight: 500; }
...
.log-school { font-weight: 600; font-size: var(--font-size-base, 13px); color: #0f172a; }
.log-degree { font-size: var(--font-size-base, 12px); color: #475569; margin: 2px 0; }
.log-date { font-size: var(--font-size-base, 11px); color: #94a3b8; }
</style>